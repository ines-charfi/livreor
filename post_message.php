...
<body>
    <header>
        ...
        <form method="GET" action="post_message.php">
            <input type="text" name="search" placeholder="Rechercher un mot-clé..."
    ...
    <section class="messages">
        ...
        <?php if ($searchTerm): ?>
            <p>
            <h3>Résultats de la recherche pour : </h3>"<strong><?php echo htmlspecialchars($searchTerm); ?></strong>"</p>
        <?php endif; ?>
